...
from Convertor.functions import transpose_of_data,extraction_placa,words_in_line_extraction
...
if __name__ == "__main__":
    mensaje="""
            ...
            (3) Extracción de datos para 3 columnas separadas por " / "
            """
    print(mensaje)
    ...
    if case==1:
        ...
        transposed_dataframe=words_in_line_extraction(sheet_dataframe,number_columns)
